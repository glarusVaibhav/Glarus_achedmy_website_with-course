...
import AIProductShowcase from "./AIProductShowcase";
    ...
    >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-8 min-h-[580px] lg:min-h-[640px]">
          ...
          <div className="w-full lg:w-[58%] xl:w-[60%] shrink-0 flex flex-col items-start text-left z-20">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-500/40 bg-[#0d0922]/80 backdrop-blur-xl shadow-[0_0_20px_rgba(147,51,234,0.2)] mb-6"
            >
              <Zap className="w-3.5 h-3.5 text-purple-400 fill-purple-400 animate-pulse" />
              <span className="text-[11px] sm:text-[12px] font-black tracking-wider text-white uppercase">
                ⚡ JOB-ORIENTED AI PROGRAMS • LIVE COHORTS • INTERNSHIPS • PROJECTS
              </span>
            </motion.div>
            ...
            <motion.p
              ...
              className="text-xs sm:text-sm font-black uppercase tracking-[0.25em] text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-cyan-400 to-blue-400 mb-4"
            >
            ...
            >
              ...
              <span className="relative inline-flex items-center text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 dark:from-emerald-400 dark:via-teal-300 dark:to-cyan-300">
                ...
                <span 
                  ...
                  className="text-amber-400 font-black ml-1 text-4xl sm:text-5xl cursor-pointer hover:scale-125 transition-transform inline-block select-none animate-pulse"
                ...
                <AnimatePresence>
                  {showCriteria && (
                    <motion.div
                      ...
                      className="absolute top-full left-0 mt-3 w-[320px] sm:w-[360px] p-5 rounded-2xl bg-[#0d0926]/95 border border-amber-400/40 backdrop-blur-2xl shadow-[0_10px_40px_rgba(0,0,0,0.8)] z-50 text-left normal-case tracking-normal"
                    >
                      <div className="flex items-center gap-2 mb-3 text-amber-400 font-black text-sm uppercase tracking-wider">
                        <Sparkles className="w-4 h-4" />
                        <span>Internship Eligibility Criteria *</span>
                      </div>
                      <ol className="space-y-2.5 text-xs sm:text-sm text-slate-200 font-medium">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="flex items-center justify-center w-5 h-5 rounded-full bg-cyan-500/20 text-cyan-400 font-bold text-xs shrink-0 mt-0.5">2</span>
                          <span><strong>Pass Internal Interview:</strong> Clear the technical assessment &amp; mock interview.</span>
                        </li>
                      </ol>
                      <p className="text-[11px] text-slate-400 mt-3 pt-2 border-t border-white/10 italic">
            ...
            <motion.div
              ...
              className="text-[17px] sm:text-[20px] text-slate-300/90 font-medium leading-relaxed max-w-[620px] mb-8 space-y-2.5"
            >
              <p>
            ...
            >
              ...
              <Link
                ...
                className="h-[60px] px-9 rounded-full border border-purple-500/40 bg-[#0e0a26]/60 backdrop-blur-xl text-white font-bold text-[16px] hover:bg-purple-900/30 hover:border-purple-400/60 transition-all flex items-center justify-center gap-2.5"
              >
                View Live Cohorts
              ...
              {FLOATING_CARDS.map((card, i) => (
                ...
                >
                  <motion.div
                    ...
                    className={`p-2.5 sm:p-3 rounded-2xl bg-[#0b081e]/95 backdrop-blur-2xl border ${card.cardBorder} flex items-center gap-2.5 transition-all cursor-pointer shadow-xl`}
                  >
                    <div className={`p-2 rounded-xl border ${card.iconBg} shrink-0`}>
                      <card.icon className="w-3.5 h-3.5" />
                    </div>
                    <div className="min-w-0 pr-1">
                      <h5 className="text-[11.5px] font-black text-white leading-tight truncate">{card.title}</h5>
                      <p className="text-[10px] font-medium text-slate-400 mt-0.5 truncate">{card.desc}</p>
                    </div>
                  </motion.div>
                </motion.div>
              ))}
      ...
      <div className="relative z-20 max-w-[1560px] w-full mx-auto px-6 sm:px-10 lg:px-14 pb-16">
        <motion.div
          ...
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 p-7 sm:p-8 rounded-[28px] border border-purple-500/30 shadow-[0_20px_60px_rgba(0,0,0,0.7)]"
          style={{
        ...
        >
          {HERO_PILLARS.map((p, i) => (
            <div key={i} className="flex items-start gap-4 p-3.5 rounded-2xl hover:bg-white/[0.05] transition-colors">
              <div className={`p-3 rounded-2xl ${p.bg} border ${p.color} shrink-0 mt-0.5`}>
                <p.icon className="w-6 h-6" />
              </div>
              <div>
                <h4 className="text-[15px] sm:text-[16px] font-black text-white leading-tight">{p.title}</h4>
                <p className="text-[12.5px] sm:text-[13px] font-medium text-slate-300/80 mt-1.5 leading-relaxed">{p.desc}</p>
              </div>
            </div>
          ))}
        </motion.div>
      ...
      <div className="relative z-10 max-w-[1560px] w-full mx-auto px-6 sm:px-10 lg:px-14">
        ...
        <div className="mb-24 pt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <Link href="/courses?type=live" className="absolute inset-0 z-20" aria-label="Explore Live Cohorts" />
              ...
              <div>
                ...
                <p className="text-base text-slate-700 dark:text-slate-300/80 font-medium leading-relaxed max-w-xl">
                  Stop watching outdated pre-recorded videos. Work alongside senior AI leaders in live, interactive code-along cohorts where you debug production code, optimize prompts, and solve real architectural challenges together.
                </p>
              </div>
            ...
            <motion.div 
              ...
              whileHover={{ y: -6 }}
              className="p-8 rounded-3xl bg-white dark:bg-[#0c0922]/85 border border-cyan-200 dark:border-cyan-500/30 hover:border-cyan-500/60 shadow-xl dark:shadow-[0_20px_60px_rgba(0,0,0,0.6)] backdrop-blur-xl relative overflow-hidden group transition-all flex flex-col justify-between cursor-pointer"
            >
              <Link href="/courses?type=self-paced" className="absolute inset-0 z-20" aria-label="Explore Production Code" />
              <div className="absolute top-0 right-0 w-[200px] h-[200px] bg-cyan-500/10 rounded-full blur-[80px] pointer-events-none group-hover:bg-cyan-500/20 transition-all" />
              <div>
                <div className="flex items-center justify-between mb-6">
                ...
                <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-3 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 transition-colors">
              ...
              <div className="mt-8 pt-6 border-t border-slate-200 dark:border-white/10 flex items-center justify-between text-xs font-bold text-slate-600 dark:text-slate-400 relative z-10">
                <span className="text-cyan-700 dark:text-cyan-400 font-extrabold">Verified GitHub Portfolio</span>
            ...
            <motion.div 
              ...
              whileHover={{ y: -6 }}
              className="p-8 rounded-3xl bg-white dark:bg-[#0c0922]/85 border border-emerald-200 dark:border-emerald-500/30 hover:border-emerald-500/60 shadow-xl dark:shadow-[0_20px_60px_rgba(0,0,0,0.6)] backdrop-blur-xl relative overflow-hidden group transition-all flex flex-col justify-between cursor-pointer"
            >
              <Link href="/courses?type=live" className="absolute inset-0 z-20" aria-label="Explore Real Experience" />
              <div className="absolute top-0 right-0 w-[200px] h-[200px] bg-emerald-500/10 rounded-full blur-[80px] pointer-events-none group-hover:bg-emerald-500/20 transition-all" />
              <div>
                <div className="flex items-center justify-between mb-6">
                ...
                <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-3 group-hover:text-emerald-600 dark:group-hover:text-emerald-300 transition-colors">
              ...
              <div className="mt-8 pt-6 border-t border-slate-200 dark:border-white/10 flex items-center justify-between text-xs font-bold text-slate-600 dark:text-slate-400 relative z-10">
                <span className="text-emerald-700 dark:text-emerald-400 font-extrabold">Real-world Project Work</span>
        ...
        {/* What You'll Build Showcase - Premium Hero Showcase */}
        <AIProductShowcase />
      </div>
    </section>
  );
